...
public class InvalidBookException extends LibraryException {
    ...
    public InvalidBookException(String mesage, String bookTitle, String invalidField) {
        super(mesage, "INVALID_BOOK");
    ...
    public String getMessage() {
        String msg = "[INVALID_BOOK] " + super.getMessage() + " (Book: '" + bookTitle + "', Invalid Field: " + invalidField;
            if (invalidValue != null) {
                msg += ", Value: '" + invalidValue + "'";
            }
        msg += ")";
        return msg;
    }
