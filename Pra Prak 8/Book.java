...
public class Book {
	...
	public void borrowBook() throws BookNotAvailableException {
		if (availableCopies <= 0) {
			throw new BookNotAvailableException("No copies available", title, 1, availableCopies);
    }
		availableCopies--;
	}
	...
	public void returnBook() throws InvalidBookException {
		if (availableCopies >= copies) {
			throw new InvalidBookException("Cannot return more books than total copies", title, "availableCopies");
		}
		availableCopies++;
	}
