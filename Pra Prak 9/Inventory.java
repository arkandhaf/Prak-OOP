  ...
  public void stackSimilarItems() {
    ...
    for (Map.Entry<String, List<Map.Entry<String, Item>>> groupEntry : itemGroups.entrySet()) {
      ...
      if (entries.size() > 1) {
        ...
        Map.Entry<String, Item> firsEntry = entries.get(0);
        firsEntry.getValue().setQuantity(totalQuantity);
        ...
        System.out.println("Stacked " + entries.size() + " instance of " + groupEntry.getKey());
      }
    }
  }
