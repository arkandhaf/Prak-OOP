public final class Pengelola implements User {
    ...
    // String username;
    // String password;
    private static int pengelolaCounter = 0;
    private String NIP;
    ...
    public Pengelola() {
        ...
        this.username = null;
        this.password = null;
        this.NIP = "2" + String.format("%05d",pengelolaCounter);
        // TODO: answer here
    }
    ...
    */
    ...
    public void perkenalkan() {
        System.out.println("Halo, saya pengelola dengan NIP " + NIP + " dan username " + username);
        //TODO: answer here
    }
    ...
    public void terimaPendaftaran(Mahasiswa mhs, Asrama asrama) {
        if(mhs.getAsrama() != null) {
            ...
            System.out.println("Pendaftaran mahasiswa " + mhs.getUsername() + " telah diverifikasi oleh pengelola " + username);
        } else {
